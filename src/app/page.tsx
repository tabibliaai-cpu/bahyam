...
function PricingPreview() {
  const plans = [
    ...
    { name: 'Starter', price: '$9', features: ['5 APIs', '5min checks', 'Slack alerts', 'Status page'], popular: false },
    { name: 'Growth', price: '$19', features: ['25 APIs', '1min checks', 'Team (3)', 'AI diagnosis'], popular: true },
    { name: 'Scale', price: '$39', features: ['Unlimited APIs', '30sec checks', 'Team (10)', 'Load testing'], popular: false },
  ];
  return (
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {plans.map(p => (
            <div key={p.name} className={`rounded-xl border p-6 relative ${p.popular ? 'ring-2' : ''}`} style={{ background: 'var(--bg-card)', borderColor: p.popular ? 'var(--accent)' : 'var(--border)', ringColor: p.popular ? 'var(--accent)' : '' }}>
