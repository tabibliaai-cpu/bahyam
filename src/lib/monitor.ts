        ...
        messages: [
          {
            role: 'system',
            content:
              'You are an expert API reliability engineer. Analyze API failures and provide concise diagnosis. Always respond in JSON with fields: diagnosis, fix, severity (low/medium/high/critical)',
          },
          {
            role: 'user',
